const webpack = require('webpack'); // Cypress webpack bundler adaptor
...
const webpackOptions = fw.getWebpackOptions(); // Preventing chunks because we don't serve static assets
...
function preventChunking(options = {}) {
  ...
  options.plugins.push(new webpack.optimize.LimitChunkCountPlugin({
...
const onFileDefaultPreprocessor = webpackPreprocessor({
  webpackOptions
});
/**
